<template>
    <div>
        ...
        <form class="form" v-else @submit.prevent="hundleSubmit">
...
export default {
    data: () => ({
        ...
        category: null,
        type: "income",
        amount: minValueOfAmountOutcome,
        description: "",
    }),
        metaInfo() {
        return {
    ...
    name: "record",
    validations: {
        amount: { minValue: minValue(minValueOfAmountOutcome) },
        ...
        async hundleSubmit() {
            ...
            if (this.canCreateRecord) {
                try {
                    ...
                    this.$v.$reset();
                    this.amount = minValueOfAmountOutcome;
                    this.description = '';
                } catch (e) {}
            } else {
